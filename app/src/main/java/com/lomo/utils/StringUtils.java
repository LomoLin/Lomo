...
public class StringUtils {
     ...
     * @return
     */
    public static boolean isShield(String isShield){

        return isShield.equals("Y")?true:false;
    }

    public static String nickNameHide(String nickName){
        ...
        String hideName = nickName.charAt(0)+stringBuffer.toString()+nickName.charAt(length-1);
        return hideName;
